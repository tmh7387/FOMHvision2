/*
  # Create and populate dropdown options for fleet management
  ...
  2. Categories:
    - capability: Aircraft operational capabilities
    - equipment: Special equipment installations
    - location: Base locations for aircraft
